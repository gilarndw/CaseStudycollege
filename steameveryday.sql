...
MySQL - 5.5.32 : Database - steameveryday
*********************************************************************
*/
...
insert  into `barang`(`ID_BARANG`,`NAMA_BARANG`,`STOCK`) values (1,'Shampoo',79),(2,'Pewangi',91),(3,'Semir Ban',98),(4,'Pengkilat Kit',89);
...
insert  into `jasadikerjakan`(`ID_PENCUCI`,`ID_DETAIL_TRANSAKSI`) values (1,1),(3,1),(2,2),(1,3),(2,3),(2,4),(3,4),(1,5),(3,5),(1,6),(2,6),(2,7),(3,7),(1,8),(3,8),(1,9),(2,9),(3,10),(1,11),(2,12),(3,12);
...
insert  into `menggunakanbarang`(`ID_BARANG`,`ID_DETAIL_TRANSAKSI`,`BANYAK_DIGUNAKAN`) values (1,1,2),(1,3,2),(1,4,2),(1,5,2),(1,6,2),(1,7,2),(1,8,2),(1,9,3),(1,10,1),(1,12,2),(1,13,1),(2,1,1),(2,3,1),(2,4,1),(2,5,1),(2,6,1),(2,7,1),(2,8,1),(2,9,1),(2,12,1),(3,2,1),(3,11,1),(4,1,1),(4,3,1),(4,4,1),(4,5,1),(4,6,1),(4,7,1),(4,8,1),(4,9,1),(4,10,1),(4,12,1),(4,13,1);
...
insert  into `transaksi`(`ID_TRANSAKSI`,`ID_KASIR`,`ID_TIPE`,`ID_PELANGGAN`,`TANGGAL`,`NO_POLISI`) values (1,1,1,1,'2018-01-09','B 1242 KLO'),(2,2,1,1,'2018-01-24','B 1242 KLO'),(3,1,1,1,'2018-02-27','B 1242 KLO'),(4,1,1,1,'2018-03-23','B 1242 KLO'),(5,2,1,1,'2018-04-09','B 1242 KLO'),(6,1,1,1,'2018-07-19','B 1242 KLO'),(7,1,1,1,'2018-11-01','B 1242 KLO'),(8,1,2,2,'2018-05-24','B 6151 MLS'),(9,2,8,3,'2018-07-12','B 2563 NNJ'),(10,2,7,4,'2018-01-03','B 1776 ITA'),(11,2,4,3,'2018-10-19','B 670 BTC'),(12,1,6,1,'2018-01-18','B 0089 STR');
